...
import { ConsumedFoodScalarFieldEnum } from "../../../../enums/ConsumedFoodScalarFieldEnum";

@TypeGraphQL.ArgsType()
export class FindFirstConsumedFoodArgs {
  ...
  @TypeGraphQL.Field(_type => [ConsumedFoodScalarFieldEnum], {
    nullable: true
  })
  distinct?: Array<"id" | "userId" | "name" | "notes" | "calories" | "protien" | "fat" | "carbs"> | undefined;
}
