...
const actionResolversMap = {
  ...
  MetActivities: {
    findUniqueMetActivities: actionResolvers.FindUniqueMetActivitiesResolver,
    findFirstMetActivities: actionResolvers.FindFirstMetActivitiesResolver,
    findManyMetActivities: actionResolvers.FindManyMetActivitiesResolver,
    createMetActivities: actionResolvers.CreateMetActivitiesResolver,
    deleteMetActivities: actionResolvers.DeleteMetActivitiesResolver,
    updateMetActivities: actionResolvers.UpdateMetActivitiesResolver,
    deleteManyMetActivities: actionResolvers.DeleteManyMetActivitiesResolver,
...
const modelsInfo = {
  User: ["id", "username", "password", "units", "name"],
